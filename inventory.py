...
class Inventory():
    ...
    async def change_wearing(self, cloth, wearing:bool):
        redis = self.server.redis
    ...
    async def _get_inventory(self):
        self.inv = {"c": {"cts": {"id": "cts", "it": []},  # clothes
                          "frt": {"id": "frt", "it": []},  # fertilizer
                          "res": {"id": "res", "it": []},  # resources
                          "med": {"id": "med", "it": []},  # medicine
                          "dec": {"id": "dec", "it": []},  # decor
                          "bld": {"id": "bld", "it": []},  # buildings
                          "sds": {"id": "sds", "it": []},  # seeds
                          "fd": {"id": "fd", "it": []},  # food
                          "its": {"id": "its", "it": []},  # ?
                          "pic": {"id": "pic", "it": []}}}  # ?
    ...
    async def _check_conflicts(self, cloth):
        gender = "boy"
        if int(await self.server.redis.lindex(f"uid:{self.uid}:appearance", 2)) == 2:
            gender = "girl"
